...
public class TransitController {
    ...
    public String getNearbyBuses(BusRequest request, Model model) {
        ...
        Location personLocation = transitService.getCoordinates(request.address + " " + request.city);
        System.out.println(request.address + " " + request.city);
        model.addAttribute("myLocation", personLocation);
